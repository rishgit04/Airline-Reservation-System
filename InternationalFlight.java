...
public class InternationalFlight extends JFrame
{
	...
	public InternationalFlight(LoginPage type1)
	{
		...
		LNotes = new JLabel("<html><body><p>NOTE: Bookings with International Credit <br> Cards have temporarily been suspended.<br>This Service will resume shortly and <br>we will have a notice posted on <br>our website.We regret any inconvenience<br> caused to our passengers.</body></html>");
