...
public class DomesticFlight extends JFrame {
	...
	public DomesticFlight(LoginPage type1) {
		...
		CBFrom.setBounds(110, 40, 110, 20);

		LTo.setBounds(20, 100, 100, 20);
		CBTo.setBounds(110, 110, 110, 20);
		...
		CBClass.setBounds(110, 220, 110, 20);
		...
		LNotes = new JLabel(
				"<html><body><p>NOTE: Bookings with International Credit <br> Cards have temporarily been suspended.<br>This Service will resume shortly and <br>we will have a notice posted on <br>our website.We regret any inconvenience<br> caused to our passengers.</body></html>");
		...
		LImg2.setBounds(16, 220, 300, 220);
		LNotes.setBounds(55, 240, 380, 200);
